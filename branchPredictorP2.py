...
class BTBEntry:
	...
	def getEntryTargetBits(self):
		return self.targetBits
...
class BTB:
	...
	def getBTBTargetBits(self, entry):
		return self.entries[entry].getEntryTargetBits()
...
class BranchPredictor:
	...
	def checkTargetBits(self, PC):
		#grab the entry
		entry = self.getEntry(PC)
		#next grab the target bits for this entry
		return self.BTB.getBTBTargetBits(entry)
